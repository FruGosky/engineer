    ...
    <div className="px-4 py-5 my-5 text-center">
      ...
      <div className="col-lg-6 mx-auto">
        <p className="lead mb-4">
          POWER FBW (full body workout) – ćwiczenia na moc na wszystkie główne
          partie mięśniowe.
          <br /> HYPER LOW – ćwiczenia na hipertrofie na dolną część ciała.
          <br />
          HYPER UP – ćwiczenia na hipertrofie na górną część ciała.
          <br /> BALANS FBW – zbalansowany trening na wszystkie główne partie
          mięśniowe.
          <br /> Pod ćwiczenia „push” dobieramy ćwiczenia w których wykonujemy
          ruch pchający lub wyciskający, analogicznie pod ćwiczenia „pull”
          dobieramy ćwiczenia, w których wykonujemy ruch przyciągający.
        </p>
