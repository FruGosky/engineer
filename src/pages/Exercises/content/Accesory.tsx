...
export default function PlanForIntermediate() {
  ...
  return (
    <div className="mt-5 card-body shadow">
      <h2 className="text-center">Accesory</h2>
      <table className="table text-center">
        <caption className="text-center">{TRANSLATED_CAPTION}</caption>

        <thead>
          <tr>
            <th scope="col">{`${TRANSLATED_TRAINING} A - POWER FBW (4x3 do 5)`}</th>
            <th scope="col">{`${TRANSLATED_TRAINING} B - POWER FBW (4x3 do 5)`}</th>
            <th scope="col">{`${TRANSLATED_TRAINING} C - POWER FBW (4x3 do 5)`}</th>
            <th scope="col">{`${TRANSLATED_TRAINING} D - POWER FBW (4x3 do 5)`}</th>
          </tr>
        </thead>
        <tbody>
          <tr>
